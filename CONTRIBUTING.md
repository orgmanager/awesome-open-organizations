...
# The pull request should have a useful title. Pull requests with `Update readme.md` as title will be closed right away because I'm so tired of nobody reading this document. Please carefully read everything before submitting a PR.
...
- Use the following format: `[Organization Name](link)`
...
1. Access the lists list's GitHub page. ([https://git.io/vSLrC](https://git.io/vSLrC))
